...
def montar_payload_financeiro(relatorio):
    return {
        "resumo_global": {
            ...
            "despesas_reembolsaveis": _str_money(relatorio.total_despesas_reembolsaveis),
            "km": _str_money(relatorio.total_km),
            "km_cobranca_cliente": _str_money(relatorio.valor_km_cobrar_cliente),
            "km_ressarcir": _str_money(relatorio.valor_km_ressarcir),
            ...
            "valor_removido_reembolso": _str_money(relatorio.valor_removido_reembolso),
            "adiantamento": _str_money(relatorio.valor_adiantamento),
            "saldo_aprovado": _str_money(relatorio.saldo_aprovado),
            "total_a_reembolsar": _str_money(relatorio.total_a_reembolsar),
