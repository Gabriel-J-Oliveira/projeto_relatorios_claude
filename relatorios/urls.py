...
urlpatterns = [
    ...
    path("manutencao/politicas/", views.manutencao_politicas_view, name="manutencao_politicas"),
    path("manutencao/politicas/nova/", views.manutencao_politica_criar_view, name="manutencao_politica_criar"),
    path("manutencao/politicas/<int:pk>/editar/", views.manutencao_politica_editar_view, name="manutencao_politica_editar"),
    path("manutencao/politicas/<int:pk>/duplicar/", views.manutencao_politica_duplicar_view, name="manutencao_politica_duplicar"),
    path("manutencao/politicas/<int:pk>/encerrar/", views.manutencao_politica_encerrar_view, name="manutencao_politica_encerrar"),
    ...
    path("anexos/<int:pk>/remover/", views.anexo_remover_view, name="anexo_remover"),
    ...
    path("despesas/<int:pk>/comprovante/remover/", views.despesa_comprovante_remover_view, name="despesa_comprovante_remover"),
